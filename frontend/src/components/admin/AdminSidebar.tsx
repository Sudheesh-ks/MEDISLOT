      ...
      <div className="relative z-10 p-6 border-b border-white/10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg bg-gradient-to-r ${grad}`}
            >
              A
            </div>
            {!isCollapsed && (
              <div>
                <h1
                  className={`text-xl font-bold bg-gradient-to-r ${grad} bg-clip-text text-transparent`}
                >
                  Admin&nbsp;Panel
                </h1>
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    {isActive && (
                      <span
                        className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${grad} rounded-r-full`}
                      />
                    )}
