      ...
      <div className="m-5">
        <div className="flex flex-wrap gap-6 justify-center">
          <div
            ...
            className="flex items-center gap-2 bg-blue-100 p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all"
          >
        ...
        <div className="bg-white">
          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestAppointments.map(
              (item: AppointmentTypes, index: number) => (
                <div
