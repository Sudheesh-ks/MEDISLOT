        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800">
              ...
              {/* Content Area */}
              <div className="min-h-96 bg-slate-800 border border-slate-700 rounded-lg p-4 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent">
                <textarea
                  onChange={(e) => setContent(e.target.value)}
                  placeholder="Start writing your article content here..."
                  className="w-full h-96 bg-transparent text-slate-100 placeholder-slate-500 resize-none focus:outline-none"
                />
              </div>
