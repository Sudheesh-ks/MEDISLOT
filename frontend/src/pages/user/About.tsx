      ...
      <main className="max-w-7xl mx-auto px-4 md:px-10 py-24 text-slate-100 animate-fade">
        ...
        <section className="flex flex-col md:flex-row gap-12 mb-24">
          ...
          <div className="flex flex-col justify-center gap-6 text-sm text-slate-400 md:w-2/3">
            <p>
              Welcome to <span className="text-slate-100 font-semibold">MediSlot</span>, your
              trusted partner in managing healthcare needs conveniently and efficiently. We
              understand the challenges individuals face when it comes to scheduling doctor
              appointments and keeping track of medical records.
            </p>
            <p>
              We are committed to excellence in healthcare technology. By continuously integrating
              the latest advancements, we deliver a superior user experience. Whether you're booking
              your first appointment or managing ongoing care, MediSlot is here for you.
            </p>
