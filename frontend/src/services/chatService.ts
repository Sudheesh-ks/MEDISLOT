...
export const userChat = {
  ...
  markRead: (chatId: string, userId: string) => api.patch(CHAT_API.MARK_READ(chatId), { userId }),
};
...
export const getPresence = (id: string) => api.get<{ online: boolean }>(`/api/presence/${id}`);
